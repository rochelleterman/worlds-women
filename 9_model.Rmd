...
```{r}
# MUSLIM MAJORITY
logit1 <- glm(n.binary ~ n.binary.lag + count + women_composite*muslim.maj + polity2 + domestic9 + log(pop.wdi) + log(gdp.pc.un), data = rt, family = binomial(link="probit"), control = list(maxit = 50))
summary(logit1)
...
# muslim majority
logit.r4.1 <- glm(n.binary ~ n.binary.lag + count + women_composite*muslim.maj + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),data = rt.no.israel, family = "binomial")
logit.r4.1.se <- coeftest(logit.r4.1, vcov=function(x) vcovHC(x, cluster="group", type="HC1"))[,2]

# mena
logit.r4.2 <- glm(n.binary ~ n.binary.lag + count + women_composite*mena + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),data = rt.no.israel, family = "binomial")
logit.r4.2.se <- coeftest(logit.r4.2, vcov=function(x) vcovHC(x, cluster="group", type="HC1"))[,2]

# muslim percentage
logit.r4.3 <- glm(n.binary ~ n.binary.lag + count + women_composite*muslim + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),data = rt.no.israel, family = "binomial")
...
interaction_plot_continuous(nb3, effect="women_composite", moderator="lag(muslim, 1)", interaction="women_composite:lag(muslim, 1)", mean=T, title="",xlabel="Percentage Muslim", ylabel="Marginal Effect of Women's Rights on Coverage")
dev.off()

# PRINT
stargazer(nb1, nb2, nb3, type = "latex", out = "Results/regressions/main-results/negbin.tex", label = "table:negbin", title = "Negative Binomial Analysis of U.S. News Coverage about Women Abroad", style = "ajps", se = list(nb1.se, nb2.se, nb3.se), notes="Robust standard errors clustered on country appear in parentheses.",  dep.var.labels = "Reported (Count)", covariate.labels=c("Lagged DV", "Country Reports", "Women's Rights Index","Muslim Majority","MENA", "Muslim Percentage", "Democracy", "Instability", "Population", "GDP per capita", "Women's Rights x Muslim Majority", "Women's Rights x MENA","Women's Rights x Muslim Percentage"), star.cutoffs = c(0.05, 0.01, 0.001))
```
...
# muslim majority
nb.r4.1 <- glm.nb(n.binary ~ n.binary.lag + count + women_composite*muslim.maj + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),data = rt.no.israel)
nb.r4.1.se <- coeftest(nb.r4.1, vcov=function(x) vcovHC(x, cluster="group", type="HC1"))[,2]

# mena
nb.r4.2 <- glm.nb(n.binary ~ n.binary.lag + count + women_composite*mena + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),data = rt.no.israel)
nb.r4.2.se <- coeftest(nb.r4.2, vcov=function(x) vcovHC(x, cluster="group", type="HC1"))[,2]

# muslim percentage
nb.r4.3 <- glm.nb(n.binary ~ n.binary.lag + count + women_composite*muslim + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),data = rt.no.israel)
...
heckit.r1.1 <- heckit(n.binary ~ n.binary.lag + count + wopol*muslim.maj + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wopol + muslim.maj + polity2 + physint,
                      rt)
...
heckit.r1.2 <- heckit(n.binary ~ n.binary.lag + count + wopol*mena + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wopol + mena + polity2 + physint,
                      rt )
...
heckit.r1.3 <- heckit(n.binary ~ n.binary.lag + count + wopol*muslim + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wopol + muslim + polity2 + physint,
                      rt )
...
heckit.r2.1 <- heckit(n.binary ~ n.binary.lag + count + wosoc*muslim.maj + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wosoc + muslim.maj + polity2 + physint,
                      rt)
...
heckit.r2.2 <- heckit(n.binary ~ n.binary.lag + count + wosoc*mena + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wosoc + mena + polity2 + physint,
                      rt )
...
heckit.r2.3 <- heckit(n.binary ~ n.binary.lag + count + wosoc*muslim + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wosoc + muslim + polity2 + physint,
                      rt )
...
heckit.r3.1 <- heckit(n.binary ~ n.binary.lag + count + wecon*muslim.maj + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wecon + muslim.maj + polity2 + physint,
                      rt)
...
heckit.r3.2 <- heckit(n.binary ~ n.binary.lag + count + wecon*mena + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wecon + mena + polity2 + physint,
                      rt )
...
heckit.r3.3 <- heckit(n.binary ~ n.binary.lag + count + wecon*muslim + polity2 + domestic9 + log(pop.wdi) +log(gdp.pc.un),
                      rights ~ lag(rights) + wecon + muslim + polity2 + physint,
                      rt )
