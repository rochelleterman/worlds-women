...
# 5) Runs a few different regressiong models
# 6) Does some robustness tests on those models
...
## write
write.csv(rt.impute,"Data/country-year/country-year-rights-imputed.csv")
